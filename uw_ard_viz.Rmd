...
uw = "https://raw.githubusercontent.com/avisokay/ard_viz/master/uw.png"
wsu = "https://raw.githubusercontent.com/avisokay/ard_viz/master/wsu.png"
gu = "https://raw.githubusercontent.com/avisokay/ard_viz/master/gonzaga.png"

#dataset
nodes = data.frame(id = 1:10,
                  label = as.character(1:10),
                  shape = "circularImage",
                  image = c(uw, wsu, gu, wsu, uw),
                  size = 30, 
                  font.size = 25,
                  align = "center",
                  group = c(rep("red", 5), 
                  ...
                  color.background = c(rep("red", 5), 
                                       rep("purple", 5)),
                  color.border = "black",
                  color.highlight.background = c(rep("red", 5), 
                                                 rep("purple", 5)),
