...
### Each node is randomly assigned to one of two communities: $c$, designated by the color (***Lavender***) or $c^{\prime}$, designated by the color (***Pink***).
```{r, echo=FALSE}
# images as nodes
...
### Next, let's assign a school mascot trait $k$ to each node; either a ***Husky***, ***Cougar***, or a ***Bulldog***. In practice, these traits could be other observable characteristics such as age, education, health status, etc.
...
### For this example, a node is more likely to be a ***Husky*** if it is in the ***Lavender*** community, more likely to be a ***Cougar*** if it is in the ***Pink*** community, and equally likely to be a ***Bulldog*** regardless of community.
