...
### Aggregating responses $y_i$ yields the following ***ARD*** table, $Y$.
...
### Then for each ARD response $y_i$ we disaggregate
...
#         col(6, tags$iframe(style="height:600px; width:100%", src="http://127.0.0.1:6895/viz_presentation_slides.Rmd"))
#       )
#     )
#   )
# ))
